...
const buttonVariants = tv({
	...
	variants: {
		...
		solid: {
			default:
				'bg-gray-800 text-white hover:bg-gray-900 disabled:opacity-50 dark:bg-white dark:text-neutral-800',
		...
		ghost: {
			default:
				'border-transparent text-gray-800 hover:bg-gray-100 dark:text-white dark:hover:bg-neutral-700',
			...
			yellow:
				'border-transparent text-yellow-500 hover:bg-yellow-100 dark:hover:bg-yellow-800/30 dark:hover:text-yellow-400',
			white:
				'border-transparent text-white hover:bg-gray-100 dark:hover:bg-white/10 dark:hover:text-white'
		},
		soft: {
			default:
				'border-transparent bg-gray-100 text-gray-800 dark:bg-white/10 dark:hover:bg-white/20 dark:text-white dark:hover:text-white',
			...
			yellow:
				'border-transparent bg-yellow-100 dark:hover:bg-yellow-900 dark:text-yellow-500 dark:hover:text-yellow-400',
			white: 'border-transparent bg-white/10 '
		},
		white: {
			default:
				'border-gray-200 bg-white text-gray-800 shadow-sm dark:bg-neutral-900 dark:border-neutral-700 dark:text-white dark:hover:bg-neutral-800',
